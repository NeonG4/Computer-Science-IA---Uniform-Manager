-- =============================================
-- COMPLETE RESET - Simple Default Database
-- This creates the database in the default location
-- =============================================
...
PRINT 'Using default SQL LocalDB location'
PRINT '========================================='
PRINT ''
...
PRINT 'Creating database in default location...'
GO

-- Create database (SQL will use default paths)
...
-- OrganizationJoinRequests Table
...
PRINT 'Location: Default SQL LocalDB path'
PRINT ''
...
PRINT '  ? OrganizationJoinRequests'
PRINT ''
PRINT 'Next: Restart Azure Function (F5)'
PRINT '========================================='
GO
